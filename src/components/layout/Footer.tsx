      ...
      <div className="border-b border-background/10">
        <div className="container py-16 text-center">
          ...
          <p className="text-background/60 text-sm mb-8 max-w-md mx-auto">
            Be the first to discover new collections, private sales, and curated style inspiration.
          </p>
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 h-12 px-4 bg-background/10 border border-background/20 text-background text-sm placeholder:text-background/40 focus:outline-none focus:border-background/40"
            />
